...
```bash
git remote add encore encore://ai-study-forge-mvp-qvu2
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/ai-study-forge-mvp-qvu2/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/ai-study-forge-mvp-qvu2/settings/integrations/github)
